...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen bg-cover bg-center flex items-center justify-center" style={{backgroundImage:"url('/images/img1.jpg')",}}>
      <div className="bg-black/50 backdrop-blur-m border border-white/30 shadow-2xl rounded-3xl px-10 py-12 w-full max-w-md text-white">
        <h1 className="text-4xl font-extrabold mb-8 text-center drop-shadow-md">Create Your Account </h1>

        <form onSubmit={handleSignup} className="space-y-5">

          <input type="email" placeholder="Email"
            className="w-full px-4 py-3 bg-white/20 rounded-lg text-dark placeholder-white/90 focus:outline-none focus:ring-2 focus:ring-cyan-400"
        ...
        <p className="mt-6 text-center text-white/80"> Already have an account?{" "}
